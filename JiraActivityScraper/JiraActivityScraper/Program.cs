    ...
    class Program
    {
        ...
        static async void MainAsync(string[] args)
        {
            ...
            catch (Exception e)
            {
                ...
                {
                    Console.WriteLine("A 401 error indicates that the Jira server could not authenticate. Check you Jira Username and Jira Password in the app.config file and make sure you are connected to the LCS network.");
                }
            }
        }
